...
package nl.knaw.dans.lobstorecli;
...
@Command(name = "lob-store",
         mixinStandardHelpOptions = true,
         versionProvider = PicocliVersionProvider.class,
         description = "CLI for dd-lob-store")
@Slf4j
public class DdLobStoreCli extends AbstractCommandLineApp<DdLobStoreCliConfig> {
    public static void main(String[] args) throws Exception {
        new DdLobStoreCli().run(args);
    }

    public String getName() {
        return "CLI for dd-lob-store";
    }
