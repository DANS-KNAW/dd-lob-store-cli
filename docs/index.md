...
2. Extract it to some location on your system, for example `/opt/dans.knaw.nl/dd-lob-store-cli`.
3. Start the service with the following command
   ```
   /opt/dans.knaw.nl/dd-lob-store-cli/bin/dd-lob-store-cli server /opt/dans.knaw.nl/dd-lob-store-cli/cfg/config.yml 
   ```
